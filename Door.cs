...
public class Door : MonoBehaviour
{
    ...
    //this variable will be used in both the door object and the collectibles we will use it to trigger the opening of the door
    [HideInInspector]
    ...
    public void DecrementCollectibles()
    {
        ...
        countText.text = "MASKS: " + collectiblesCount.ToString() + "/5";
        ...
        if (collectiblesCount == 5)
        {
            ...
            winText.text = "The frogs are fooled!";
        }
    }
